...
from backend.PULSEdata import PULSEdata, PULSEparser
...
class SubwindowSetup(QMdiSubWindow):
    ...
    def setup_ui(self) -> None:
        ...
        self.filename_filter = QLineEdit("pulseLIV|pulseSP")
        ...
        self.extention_edit = QLineEdit("pliv|pspctrm")
        ...
        naming_overwrite_button.setToolTip(
